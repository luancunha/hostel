...
<div class="container" style="height: auto; margin-top: 130px;">
          ...
          <br/>
            <div class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="email" name="email" class="form-control" placeholder="{{ __('E-mail') }}" value="" required>
              </div>
              @if ($errors->has('email'))
            ...
            <div class="form-check mr-auto ml-3 mt-3 text-center">
              <label class="form-check-label">
                <input class="form-check-input" type="checkbox" name="remember" data-switch-no-init="data-switch-no-init" {{ old('remember') ? 'checked' : '' }}> {{ __('Lembrar de mim') }}
