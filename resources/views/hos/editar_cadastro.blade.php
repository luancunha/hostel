@extends('layouts.app2', ['activePage' => 'hospede', 'titlePage' => __('Edite_Hospede')])
...
<div class="wrapper ">
  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="/hospede/hos/{{$hos->id}}" autocomplete="off" class="form-horizontal">
            @csrf
            ...
            <div class="card">
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-4">
                          ...
                          <div class="col-sm-7">
                              <div class="form-group">
                                  <input class="form-control" name="org" value="{{$hos->org}}" id="org" type="text" placeholder=""/>
                              </div>
                          </div>
                      </div>
                  </div>
