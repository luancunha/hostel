            ...
            <div class="col-md-12">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input class="form-control" name="nome" id="nome" type="text" value="{{ $email = Auth::user()->name }}" placeholder="" required="true" aria-required="true"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                            <input class="form-control" name="email" id="email" type="hidden" value="{{ $email = Auth::user()->email }}" placeholder="" required="true" aria-required="true"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
