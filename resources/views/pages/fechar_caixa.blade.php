@extends('layouts.app', ['activePage' => 'caixa', 'titlePage' => __('Fechar Caixa')])
...
<div class="content">
    <div class="container-fluid">
        ...
        <form method="POST" action="/caixa/fecha" autocomplete="off" class="form-horizontal">
            @csrf

            <div class="card" style="width: 900px;">
                <div class="card-header card-header-primary">
                <h4 class="card-title text-center text-white">{{ __('Fechar Caixa') }}</h4>
            ...
            <div class="row">
                ...
                <div class="col-auto">
                    <label class="col-sm col-form-label-lg">{{ __('Valor final') }}</label>
                    <div class="col-sm-12">
                        <div class="form-group">
